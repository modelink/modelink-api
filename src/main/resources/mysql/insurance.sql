...
CREATE TABLE `insurance` (
  ...
  `birthday` timestamp NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '投保人生日',
  ...
  `arrange_time` timestamp NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '下发时间',
  ...
  `finish_time` timestamp NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '成单日期',
