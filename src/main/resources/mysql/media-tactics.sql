...
CREATE TABLE `media_tactics` (
  ...
  `optimite_key_word` int(11) NOT NULL DEFAULT 0 COMMENT '关键词优化（次）',
  `add_bid` int(11) NOT NULL DEFAULT 0 COMMENT '增加出价（次）',
  `reduce_bid` int(11) NOT NULL DEFAULT 0 COMMENT '降低出价（次）',
  `add_pattern` int(11) NOT NULL DEFAULT 0 COMMENT '调宽匹配模式（次）',
  `reduce_pattern` int(11) NOT NULL DEFAULT 0 COMMENT '调窄匹配模式（次）',
  ...
  `optimite_word_idea` int(11) NOT NULL DEFAULT 0 COMMENT '文字创意优化（次）',
  `add_style` int(11) NOT NULL DEFAULT 0 COMMENT '增加图片等高级样式（次）',
  `add_word_idea` int(11) NOT NULL DEFAULT 0 COMMENT '增加文字创意（次）',
  `optimite_image_idea` int(11) NOT NULL DEFAULT 0 COMMENT '展示类图片创意优化（次）',
  ...
  `optimite_flow_idea` int(11) NOT NULL DEFAULT 0 COMMENT '信息流文字创意优化（次）',
  `modify_copywrite` int(11) NOT NULL DEFAULT 0 COMMENT '文案调整（次）',
  `optimite_flow_people` int(11) NOT NULL DEFAULT 0 COMMENT '信息流人群优化（次）',
