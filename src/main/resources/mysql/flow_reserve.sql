...
CREATE TABLE `flow_reserve` (
  ...
  `loggerDate` varchar(10) NOT NULL DEFAULT '' COMMENT '日期',
  ...
  `reserve_no` varchar(32) NOT NULL DEFAULT '' COMMENT '预约编号',
  ...
  `advertise_desc` varchar(56) NOT NULL DEFAULT '' COMMENT '广告描述',
  ...
  `first_advertise_desc` varchar(56) NOT NULL DEFAULT '' COMMENT '首次点击广告描述',
  ...
  `website` varchar(56) NOT NULL DEFAULT '' COMMENT '网站来源',
  `browser` varchar(56) NOT NULL DEFAULT '' COMMENT '浏览器',
  ...
  `last2_advertise_desc` varchar(56) NOT NULL DEFAULT '' COMMENT '最后2次点击广告描述',
  ...
  `last3_advertise_desc` varchar(56) NOT NULL DEFAULT '' COMMENT '最后3次点击广告描述',
