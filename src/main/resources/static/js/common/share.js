(function() {
    ...
    function _initWX(data) {
        ...
        require([wxapi], function(wx) {
            ...
            wx.config({debug:true, appId:conf.appId, timestamp:conf.timestamp, nonceStr:conf.nonceStr, signature:conf.signature, jsApiList:["onMenuShareTimeline", "onMenuShareAppMessage", "onMenuShareQQ", "onMenuShareQZone"]});
