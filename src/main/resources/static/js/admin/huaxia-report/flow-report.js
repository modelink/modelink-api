layui.define(['form', 'table', 'element', 'laydate', 'jquery', 'upload'], function (exports) {
    ...
    form.on('submit(search-btn)', function(data){
        table.reload('flow-report-table-reload',{
            page: { curr: 1 },
            where: {
    ...
    //方法级渲染
    table.render({
        elem: '#flow-report-table-grid',
        url: '/admin/huaxiaFlowReport/list',
        cols: [
            [
                ...
                {field: 'browseCount', title: '浏览量', minWidth: 160, align: 'center'},
                {field: 'clickCount', title: '点击量', minWidth: 160, align: 'center'},
                {field: 'arriveCount', title: '到达量', minWidth: 120, align: 'center'},
                {field: 'arriveUserCount', title: '到达用户', minWidth: 100, align: 'center'},
                {field: 'againCount', title: '二跳量', minWidth: 100, align: 'center'},
        ...
        response: {
            ...
            upload.render({
                elem: '#importExcel',
                url: '/admin/huaxiaFlowReport/importExcel',
                accept: 'file',
